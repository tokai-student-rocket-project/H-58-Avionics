...
|   1kHz加速度   |       500~1kHzで計測       |         1kHz~で計測          | ダウンリンクの遅延送信 |
...
| データ | センサ   | 出力レート | 出力先       | 通信速度 |
| ------ | -------- | ---------- | ------------ | -------- |
| 温度   | MAX31855 | 100Hz      | ダウンリンク | ~~~~~~   |
...
バルブの開検知にはマイクロスイッチを用いたリミットスイッチを搭載する。
スイッチが押された時、各種流路が90度回転したこととなり開栓しているかどうかを物理的に判断可能となる。
