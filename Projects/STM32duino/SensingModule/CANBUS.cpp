 ...
 * SJW:				1
 */
CanBusNamespace::BitrateConfig CanBusNamespace::canBitrateConfig[] = {
	{7,  1, 120},	//CAN_33K3BPS
	{13, 2, 45},	//CAN_50KBPS
	{15, 2, 20},	//CAN_100KBPS
	{13, 2, 18},	//CAN_125KBPS
 ...
 * TODO: Refactor
 */
bool CanBusNamespace::CanBus::begin(CanBusNamespace::Bitrate bitrate, CanBusNamespace::Pinout pinout) {

	RCC->APB1ENR |= 0x2000000UL;	// Enable CAN clock 
	RCC->APB2ENR |= 0x1UL;			// Enable AFIO clock
	//-- AFIO->MAPR &= 0xFFFF9FFF;		// reset CAN remap

	if (pinout == CanBusNamespace::Pinout::RX_PA11_TX_PA12) {
		//todo reformat
	...
	else if (pinout == CanBusNamespace::Pinout::RX_PB8_TX_PB9) {
		//todo reformat
	...
	else if (pinout == CanBusNamespace::Pinout::RX_PD0_TX_PD1) {
		//todo reformat
	...
	// Set bit rates 
	CanBusNamespace::BitrateConfig bitrateConfig = CanBusNamespace::canBitrateConfig[bitrate];
 ...
 * TODO: Refactor
 */
void CanBusNamespace::CanBus::setFilter(uint8_t index, uint8_t scale, uint8_t mode, uint8_t fifo, uint32_t bank1, uint32_t bank2) {
	if (index > 27) return;
...
bool CanBusNamespace::CanBus::checkReceive() {
 ...
 * TODO: Refactor
 */
void CanBusNamespace::CanBus::receive(CanBusNamespace::Frame* frame) {
 ...
 * TODO: Refactor
 */
bool CanBusNamespace::CanBus::send(CanBusNamespace::Frame* frame) {
 ...
 */
bool CanBusNamespace::Frame::isStandardFrame() {
 ...
 */
bool CanBusNamespace::Frame::isExtendedFrame() {
 ...
 */
bool CanBusNamespace::Frame::isDataFrame() {
	return (this->format == CanBusNamespace::FrameType::Data);
}

/**
 * Returns whether frame is a remote frame
 */
bool CanBusNamespace::Frame::isRemoteFrame() {
	return (this->format == CanBusNamespace::FrameType::Remote);
}

/**
 * Prints frame details
 */
void CanBusNamespace::Frame::print() {
	Serial.print("Frame (");
