...
void setup()
{
  ...
  Serial1.setRx(PA_10);
  Serial1.setTx(PA_9);
  Serial1.begin(115200, SERIAL_8E1); // パリティをなしに設定
  Serial.begin(115200);

  // Serial2.setRx(PA_3);
  // Serial2.setTx(PA_2);
  // Serial2.begin(BAUDRATE, SERIAL_8E1); // パリティをなしに設定
  ...
  int B3M_WriteCmd_ERROR_1;
  B3M_WriteCmd_ERROR_1 = B3M_WriteCmd(0x01, 0x02, 0x28); // 動作モード：Free
  Serial.print("Mode:Free = ");
  Serial.println(B3M_WriteCmd_ERROR_1);
  delay(500);

  int B3M_WriteCmd_ERROR_2;
  B3M_WriteCmd_ERROR_2 = B3M_WriteCmd(0x01, 0x02, 0x28); // 位置制御モードに設定
  Serial.print("Mode:Point =");
  Serial.println(B3M_WriteCmd_ERROR_2);
  delay(500);

  int B3M_WriteCmd_ERROR_3;
  B3M_WriteCmd_ERROR_3 = B3M_WriteCmd(0x01, 0x01, 0x29); // 起動生成タイプ：Even
  Serial.print("Type:EVEN =");
  Serial.println(B3M_WriteCmd_ERROR_3);
  delay(500);

  int B3M_WriteCmd_ERROR_4;
  B3M_WriteCmd_ERROR_4 = B3M_WriteCmd(0x01, 0x00, 0x5C); // ゲインプリセット：No.0
  Serial.print("Gain:No.0 = ");
  Serial.println(B3M_WriteCmd_ERROR_4);
  delay(500);

  int B3M_WriteCmd_ERROR_5;
  B3M_WriteCmd_ERROR_5 = B3M_WriteCmd(0x01, 0x00, 0x28); // 動作モード：Normal
  Serial.print("Mode:Normal =");
  Serial.println(B3M_WriteCmd_ERROR_5);
  delay(500);
}
...
void loop()
{
  ...
  delay(100);
  int B3M_setPos_ERROR_1;
  B3M_setPos_ERROR_1 = B3M_setPos(0x01, 5000, 500);
  Serial.print("B3M_setPos_ERROR_1 =");
  Serial.println(B3M_setPos_ERROR_1);
  delay(1000);

  int B3M_setPos_ERROR_2;
  B3M_setPos_ERROR_2 = B3M_setPos(0x01, -5000, 1000);
  Serial.print("B3M_setPos_ERROR_2 =");
  Serial.println(B3M_setPos_ERROR_2);
  delay(1000);
}
